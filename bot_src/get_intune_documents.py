...
from bot_src.config import ASSET_PATH, get_logger
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--query",
        type=str,
        help="Query to use to know compliance policies",
        default="I need compliance policies, what would you recommend?",
    )
